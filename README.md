...
- `RATE_LIMIT_GENERATE_BURST_WINDOW_SEC=10`
- `RATE_LIMIT_GENERATE_BURST_MAX=10`（生成接口并发抽卡短窗上限）
- `RATE_LIMIT_GENERATE_WINDOW_SEC=60`
- `RATE_LIMIT_GENERATE_MAX=30`
...
- `SESSION_MESSAGE_CONCURRENCY_MAX=10`（同一个 session 的生成接口并发上限，默认 10，用于并行抽卡）
